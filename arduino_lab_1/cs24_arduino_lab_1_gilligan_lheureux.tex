...
\section{Conclusion}
    ...
    \end{figure}
Overall, the lab went well. We were able to write a program which could easily be configured to match the names of an (imaginary) enduser. The wiring was simple, and was managed well on the breadboard. The use of the Serial Monitor greatly eased the burden of debugging. We also used Git for versrion control and collaboration.
